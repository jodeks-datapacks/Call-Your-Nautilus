...
$data modify storage call_your_nautilus:root data.nautilus_owner set value $(dialog_nautilus_owner)

$scoreboard players set &nautilus_owner call_your_nautilus.config $(dialog_nautilus_owner)
