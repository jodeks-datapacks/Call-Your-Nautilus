...
$data modify storage call_your_nautilus:root data.player_in_water_check set value $(dialog_player_in_water_check)
$scoreboard players set &player_in_water_check call_your_nautilus.config $(dialog_player_in_water_check)
