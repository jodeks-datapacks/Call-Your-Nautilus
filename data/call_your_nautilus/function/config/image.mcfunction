function call_your_nautilus:image/set_image_data {\
  width: 8,\
  height: 8,\
  image_data: [\
  ...
  description: [\
    ...
    "",\
    [{translate: "jodek.datapack_version", fallback: "Datapack version: ", color: "#00a800"}, {text: "v1.3.0", color: "#54fc54"}],\
    ...
    {text: "modrinth.com/datapack/call-your-nautilus", color: "#a800a8"},\
    "",\
    "",\
    "",\
    "",\
