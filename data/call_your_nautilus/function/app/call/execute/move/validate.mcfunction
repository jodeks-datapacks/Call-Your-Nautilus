...
execute unless entity @s[predicate=call_your_nautilus:no_player_on_mount] run return run function call_your_nautilus:app/feedback/fail {translate:"call_your_nautilus.fail.player_on_nautilus",fallback:"There's a player on the nautilus"}
