advancement revoke @s only call_your_nautilus:used/goat_horn_selected
...
execute as @s run function call_your_nautilus:app/call/get_data with storage call_your_nautilus:root data